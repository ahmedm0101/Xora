        ...
        <div className="container">
          <div className="relative flex flex-nowrap md:flex-wrap border-2 border-s3 rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:g7 max-md: border-none max-md:rounded-none max-md:gap-3">
            {features.map(
              (
                {
                  button: { icon: iconButton, title: titleButton },
                  caption,
                  icon,
                  id,
                  text,
                ...
                >
                  ...
                  <Button icon={iconButton}>{titleButton}</Button>
                </div>
              )
            )}
            <ul className="relative flex justify-around flex-grow px-[5%] border-2 border-s3 rounded-7xl max-md:hidden">
              ...
              {details.map(({ icon, id, title }) => (
                <li key={id} className="relative pt-16 px-4 pb-14">
                  ...
                  <div className="size-20 shadow-500 flex justify-center items-center mx-auto mb-3 border-2 border-s2 rounded-full hover:border-s4 duration-500">
                    <img
                      src={icon}
                      alt={title}
                  ...
                  <h3 className="relative max-w-36 mx-auto base-small my-0 text-center uppercase ">
                    {title}
                  </h3>
                </li>
              ))}
